...
class ServerUI():
    ...
    def __init__(self):
        ...
        # 输入消息Text，并与滚动条绑定
        ft = tkFont.Font(family='Fixdsys', size=11)
        self.inputText = Tkinter.Text(self.frame[2], width=70, height=4, font=ft)
    ...
    def receiveMessage(self):
        ...
        self.buffer = 1024
        self.chatText.insert(Tkinter.END, '小主，已经恭候您多时了^_^～')
        # 循环接受客户端的连接请求
        while True:
    ...
    def sendMessage(self):
        ...
        if self.flag == True:
            ...
            # Socket连接没有建立，提示用户
            self.chatText.insert(Tkinter.END, '连接失败，我们暂时无法收到您的消息\n')
            # 清空用户在Text中输入的消息
